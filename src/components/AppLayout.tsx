...
import Navbar from './greenconnect/Navbar';
import HeroSection from './greenconnect/HeroSection';
import FeaturesSection from './greenconnect/FeaturesSection';
import TestimonialsSection from './greenconnect/TestimonialsSection';
import EventProfileAssessment from './greenconnect/EventProfileAssessment';
import AttendeeTravel from './greenconnect/AttendeeTravel';
import VenueSustainability from './greenconnect/VenueSustainability';
import CateringMaterials from './greenconnect/CateringMaterials';
import FormatOptimizer from './greenconnect/FormatOptimizer';
import CarbonCalculator from './greenconnect/CarbonCalculator';
import CostSavingsCalculator from './greenconnect/CostSavingsCalculator';
import DashboardMetrics from './greenconnect/DashboardMetrics';
import AlternativesSection from './greenconnect/AlternativesSection';
import GreenScoreCard from './greenconnect/GreenScoreCard';
import EventPortfolio from './greenconnect/EventPortfolio';
import ResourceLibrary from './greenconnect/ResourceLibrary';
import MyEvents from './greenconnect/MyEvents';
import Footer from './greenconnect/Footer';
import AIAssistant from './greenconnect/AIAssistant';
import AuthGate from './greenconnect/AuthGate';
