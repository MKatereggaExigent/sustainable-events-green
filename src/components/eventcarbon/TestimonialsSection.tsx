...
const testimonials = [
  {
    ...
    avatar: 'SC',
    rating: 5,
    text: 'EventCarbon completely transformed how we plan our annual conference. We reduced our carbon footprint by 62% and our attendees loved the transparency. The green score card became a badge of honor for our brand.',
    company: 'TechCorp',
  ...
  },
  {
    ...
    avatar: 'ER',
    rating: 5,
    text: 'We used EventCarbon for our international summit with 2,000 attendees. The alternative suggestions alone saved us $15,000 while cutting emissions by 40%. The shareable green score was perfect for our ESG reporting.',
  ...
  },
  {
    ...
    avatar: 'DP',
    rating: 5,
    text: 'Our wedding planning business has seen a 3x increase in bookings since we started sharing EventCarbon green scores on social media. Couples love knowing their special day is also kind to the planet.',
  ...
  },
  {
    ...
    avatar: 'AO',
    rating: 5,
    text: 'The AI assistant helped us identify sustainable vendors we never knew existed. EventCarbon is now mandatory for all our event planning workflows. It pays for itself in cost savings alone.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            See how organizations worldwide are using EventCarbon to create sustainable, impactful events.
          </p>
        </div>
